...
async def generate_ai_response(messages: List[Message]):
    ...
    try:
        ...
        system_prompt = (
            "You are AuScope AI, the dedicated intelligence core designed exclusively for the AuScope Terminal. "
            "Under NO circumstances should you mention Google, Gemini, OpenAI, or any underlying AI models. If asked who created you, where you are from, or what model you are based on, strictly state that you are the Intelligence Core of AuScope. "
