      ...
      {open && (
        <div style={{
          ...
          <div style={{ padding: '12px 16px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
            <div style={{ fontSize: '13px', fontWeight: 600, color: '#e0e6ed' }}>{profile.full_name || profile.username}</div>
            <div style={{ fontSize: '11px', color: '#4a5568', marginTop: '2px' }}>{profile.email}</div>
          </div>

          {[
            { icon: '👤', label: 'Profile Hub',        href: '/profile' },
