      ...
      <div className="flex justify-center relative z-30">
        <div className="flex bg-slate-900/80 border border-slate-700/50 rounded-full p-1 backdrop-blur shadow-xl">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-1.5 rounded-full text-[10px] font-bold tracking-widest uppercase transition-all ${activeView === 'chart'
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-1.5 rounded-full text-[10px] font-bold tracking-widest uppercase transition-all ${activeView === 'map'
